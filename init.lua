...
vim.keymap.set(
  ...
  "<leader>e",
  "<cmd>Explore<cr>",
  { desc = "Open the nvim file explorer netrw", noremap = true, silent = true }
)
...
--  This autocommand is for vim-slim and sets filetype to slim, even if doctype says html
vim.api.nvim_create_autocmd({ "BufNewFile", "BufRead" }, {
  desc = "Set filetype to slim when entering a *.html.slim file",
  group = vim.api.nvim_create_augroup("slim-file-type", { clear = true }),
  pattern = "*.slim",
  callback = function()
...
require("lazy").setup({
  ...
  -- nice icons for lsp information
  {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      --  See `:help telescope.buil in.live_grep()` for information about particular keys
  ...
  { -- DBUI navigate through databases
